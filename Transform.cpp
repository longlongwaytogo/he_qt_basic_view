...
namespace {
    QVector3D toQVector3D( A3DVector3dData &v ) {
        ...
        if( xfrm ) {
            ...
            switch( xfrm_type ) {
                case kA3DTypeMiscCartesianTransformation:
                    return getMatrixFromCartesian( reinterpret_cast<A3DMiscCartesianTransformation*>(xfrm) );
                    break;
                case kA3DTypeMiscGeneralTransformation:
                    return getMatrixFromGeneralTransformation( reinterpret_cast<A3DMiscGeneralTransformation*>(xfrm) );
                    break;
                default:
